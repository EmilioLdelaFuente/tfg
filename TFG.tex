...
Para analizar el comportamiento del parque e\'olico y el controlador se modelara y analizara en Simulink los casos de estudio propuestos. En este cap\'itulo se presentara el m\'etodo usado para desarrollar el modelo del circuito el\'ectrico, el diseño del algoritmo de control y los diferentes casos que se han estudiado. \par
